...
import { MapPin, ShieldCheck, Users2, Settings, Users, Car, Building, QrCode, Ruler, FileText, Navigation, DollarSign, ListFilter, ClipboardList, BarChart, Wallet, Download, BookOpen, ArrowRight, Zap, Smartphone, TrendingUp } from 'lucide-react';
...
export default function Home() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 text-center lg:text-left animate-fade-in">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl font-bold text-white leading-[1.1] mb-9 font-poppins tracking-tight">
      ...
      {/* Call to Action */}
      <section id="get-started" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-dark-purple via-dark-card to-dark-purple px-4 sm:px-6 pt-20 pb-16 relative overflow-hidden">
        {/* Background Effects */}
        ...
        <div className="max-w-6xl mx-auto w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 text-center lg:text-left">
              ...
              <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight font-poppins tracking-tight">
